...
class DoctorSchedule extends Component {
    ...
    handleClickScheduleTime = (dataTime) => {
        this.setState({
            ...
            dataScheduleTimeModal: dataTime,
        });
    };
    closeBookingClose = () => {
        this.setState({
    ...
    render() {
        const { allDay, allAvailableTime, isOpenModalBooking, dataScheduleTimeModal } = this.state;
        const doctorId = this.state.dataScheduleTimeModal.doctorId;
                ...
                <div className="doctor-schedule-container">
                    ...
                    <div className="all-available-time">
                        ...
                        <div className="calendar-free">
                            ...
                            <i className="fas fa-hand-pointer icon-choose"></i>
                            <span>
