...
class Doctor extends Component {
    ...
    render() {
        ...
        console.log('check data top doctor: ', arrDoctor);
        return (
            <div className="section-doctor">
                <div className="predict-container">
                    <div className="predict-header">
                        ...
                        <button className="btn-section">{<FormattedMessage id={"manage-user.more-info"}/>}</button>
                    </div>
                        ...
                        <Slider {...settings}>
                            ...
                            && arrDoctor.map((doctor) => {
                                ...
                                const nameEn = `${doctor.positionData.valueEn}, ${doctor.firstName} ${doctor.lastName}`
                                    return (
                                        <div className={`option option-${doctor.id}`}>
                                            <div
                                            ...
                                            ></div>
                                            <span className="text-description">{lang === LANGUAGES.VI ? nameVi : nameEn}</span>
                                        </div>
                                    )
                            })
                            }
